...
class LymanAlphaPopulation():
    ...
    def __init__(self):
        ...
        # histogram spaces
        self.muv_space = np.linspace(-24, -16, 100)
        self.dv_space = np.linspace(0, 1000, 100)
        self.dv_logspace = 10**np.linspace(0, 3, 100)
        self.w_space = 10**np.linspace(0, 3, 100)
        self.fesc_space = np.linspace(0, 1.5, 100)
    ...
    def log_kl_divergence(self, p, q):
        """
...
if __name__ == "__main__":
    ...
    theta = model.prior()
    print("theta:", theta)
    model.set_lya_properties(theta)
