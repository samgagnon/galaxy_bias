...
axs[2].errorbar(muv, f.T[0], yerr=f_err.T[0], fmt='o', color='red', markersize=5, label='Wide')
axs[2].errorbar(muv, f.T[1], yerr=f_err.T[1], fmt='o', color='orange', markersize=5, label='Deep')
...
axs[2].plot(muv, fmw, ':', color='red')
axs[2].plot(muv, fmd, ':', color='orange')
axs[2].set_xlabel(r'${\rm M}_{\rm UV}$', fontsize=font_size)
axs[2].set_ylabel(r'$\log_{10}f_{\rm obs}$', fontsize=font_size)
