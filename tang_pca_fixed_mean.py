...
# Y = PCA T of X
os.makedirs('./data/pca_fixed_mean', exist_ok=True)
...
T = np.load('./data/pca/transformation.npy')
...
np.save('./data/pca_fixed_mean/muv.npy', muv_centers)
np.save('./data/pca_fixed_mean/params.npy', all_params)
np.save('./data/pca_fixed_mean/n_points.npy', all_n_points)
np.save('./data/pca_fixed_mean/f.npy', f)
np.save('./data/pca_fixed_mean/f_err.npy', f_err)
